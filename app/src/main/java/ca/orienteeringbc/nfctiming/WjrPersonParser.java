...
public class WjrPersonParser {
    ...
    private WjrPerson readCompetitor(XmlPullParser parser) throws IOException, XmlPullParserException {
        WjrPerson competitor = null;
    ...
    private WjrPerson readPerson(XmlPullParser parser) throws IOException, XmlPullParserException {
        WjrPerson competitor;
        ...
        competitor = new WjrPerson(compId, firstName, lastName);
        return competitor;
    }
